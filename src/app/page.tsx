    ...
    <main className="relative space-y-8 p-5">
      <Banner>
        <div className="space-y-4">
          <h3 className="inline bg-accent px-2 font-monoline text-3xl text-accent-foreground">
            Always on
          </h3>
          <h2 className="font-tusker text-6xl uppercase leading-none md:max-w-[66%]">
            Real World Data-Powered Games
          </h2>
          <p className="text-lg md:max-w-[66%]">
      ...
      <div className="z-20 grid grid-cols-2 gap-4 sm:grid-cols-3 xl:grid-cols-4">
        <Card
